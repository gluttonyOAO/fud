...
if (!function_exists('wf_single_backers_count_text')) {
    ...
    {
        return apply_filters('wf_single_backers_count_text', '贊助者');
    }
}
...
if (!function_exists('wf_single_backers_tab_text')) {
    ...
    {
        return apply_filters('wf_single_backers_tab_text', '贊助者');
    }
}
...
if (!function_exists('wf_single_invest_now_button_text')) {
    ...
    {
        return apply_filters('wf_single_invest_now_button_text', '馬上贊助');
    }
}
...
if (!function_exists('wf_single_fund_goal_text')) {
    ...
    {
        return apply_filters('wf_single_fund_goal_text', '目標金額');
    }
}
...
if (!function_exists('wf_single_fund_raised_percent_text')) {
    ...
    {
        return apply_filters('wf_single_fund_raised_percent_text', '距離目標');
    }
}
...
if (!function_exists('wf_single_fund_raised_text')) {
    ...
    {
        return apply_filters('wf_single_fund_raised_text', '募集資金');
    }
}
...
if (!function_exists('wf_archive_backers_count_text')) {
    ...
    {
        return apply_filters('wf_archive_backers_count_text', '贊助者');
    }
}
...
if (!function_exists('wf_archive_fund_goal_text')) {
    ...
    {
        return apply_filters('wf_archive_fund_goal_text','目標');
    }
}
...
if (!function_exists('wf_archive_fund_raised_percent_text')) {
    ...
    {
        return apply_filters('wf_archive_fund_raised_percent_text', '距離目標');
    }
}
...
if (!function_exists('wf_archive_fund_raised_text')) {
    ...
    {
        return apply_filters('wf_archive_fund_raised_text', "募資金額");
    }
}
...
if (!function_exists('wf_add_new_campaign_text')) {
    ...
    {
        return apply_filters('wf_add_new_campaign_text', '新增募資');
    }
}
